 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.fhir.impl.MedicationAdministrationPerformerImpl#getRole <em>Role</em>}</li>
...
@XmlRootElement(name = "fhir.MedicationAdministrationPerformer")
public class MedicationAdministrationPerformerImpl extends BackboneElementImpl implements MedicationAdministrationPerformer {
	...
	public NotificationChain basicSetRole(CodeableConcept newRole, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.MEDICATION_ADMINISTRATION_PERFORMER__ROLE, oldRole, newRole);
	...
	public void setRole(CodeableConcept newRole) {
		if (newRole != role) {
			...
			if (role != null)
				msgs = ((InternalEObject)role).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.MEDICATION_ADMINISTRATION_PERFORMER__ROLE, null, msgs);
			if (newRole != null)
				msgs = ((InternalEObject)newRole).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.MEDICATION_ADMINISTRATION_PERFORMER__ROLE, null, msgs);
			msgs = basicSetRole(newRole, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.MEDICATION_ADMINISTRATION_PERFORMER__ROLE, newRole, newRole));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FhirPackage.MEDICATION_ADMINISTRATION_PERFORMER__ROLE:
