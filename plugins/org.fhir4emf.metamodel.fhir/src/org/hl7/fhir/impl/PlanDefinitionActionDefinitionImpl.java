 ...
 *   <li>{@link org.hl7.fhir.impl.PlanDefinitionActionDefinitionImpl#getCode <em>Code</em>}</li>
 ...
 *   <li>{@link org.hl7.fhir.impl.PlanDefinitionActionDefinitionImpl#getInput <em>Input</em>}</li>
 *   <li>{@link org.hl7.fhir.impl.PlanDefinitionActionDefinitionImpl#getOutput <em>Output</em>}</li>
 ...
 * @generated
 */
@XmlType(name = "PlanDefinitionActionDefinition", namespace = "http://hl7.org/fhir")
@XmlRootElement(name = "fhir.PlanDefinitionActionDefinition")
public class PlanDefinitionActionDefinitionImpl extends BackboneElementImpl implements PlanDefinitionActionDefinition {
	 ...
	 * @ordered
	 */
	protected EList<ActionParticipantType> participantType;
	...
	public List<CodeableConcept> getCode() {
		if (code == null) {
			code = new EObjectContainmentEList<CodeableConcept>(CodeableConcept.class, this, FhirPackage.PLAN_DEFINITION_ACTION_DEFINITION__CODE);
		}
		return code;
	}
	...
	public List<RelatedArtifact> getDocumentation() {
		if (documentation == null) {
			documentation = new EObjectContainmentEList<RelatedArtifact>(RelatedArtifact.class, this, FhirPackage.PLAN_DEFINITION_ACTION_DEFINITION__DOCUMENTATION);
		}
	...
	public List<PlanDefinitionCondition> getCondition() {
		if (condition == null) {
			condition = new EObjectContainmentEList<PlanDefinitionCondition>(PlanDefinitionCondition.class, this, FhirPackage.PLAN_DEFINITION_ACTION_DEFINITION__CONDITION);
		}
		return condition;
	}
	...
	public List<DataRequirement> getInput() {
		if (input == null) {
			input = new EObjectContainmentEList<DataRequirement>(DataRequirement.class, this, FhirPackage.PLAN_DEFINITION_ACTION_DEFINITION__INPUT);
		}
		return input;
	}
	...
	public List<DataRequirement> getOutput() {
		if (output == null) {
			output = new EObjectContainmentEList<DataRequirement>(DataRequirement.class, this, FhirPackage.PLAN_DEFINITION_ACTION_DEFINITION__OUTPUT);
		}
		return output;
	}
	...
	@XmlElement
	public List<ActionParticipantType> getParticipantType() {
		if (participantType == null) {
			participantType = new EObjectContainmentEList<ActionParticipantType>(ActionParticipantType.class, this, FhirPackage.PLAN_DEFINITION_ACTION_DEFINITION__PARTICIPANT_TYPE);
		}
	 ...
	 */
	@XmlElement
	public List<PlanDefinitionActionDefinition> getActionDefinition() {
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case FhirPackage.PLAN_DEFINITION_ACTION_DEFINITION__CODE:
			...
			case FhirPackage.PLAN_DEFINITION_ACTION_DEFINITION__INPUT:
				return ((InternalEList<?>)getInput()).basicRemove(otherEnd, msgs);
			case FhirPackage.PLAN_DEFINITION_ACTION_DEFINITION__OUTPUT:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FhirPackage.PLAN_DEFINITION_ACTION_DEFINITION__PARTICIPANT_TYPE:
				...
				getParticipantType().addAll((Collection<? extends ActionParticipantType>)newValue);
				return;
			case FhirPackage.PLAN_DEFINITION_ACTION_DEFINITION__TYPE:
