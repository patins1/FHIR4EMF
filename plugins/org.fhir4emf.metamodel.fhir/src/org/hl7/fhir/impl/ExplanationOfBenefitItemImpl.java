...
@XmlRootElement(name = "fhir.ExplanationOfBenefitItem")
public class ExplanationOfBenefitItemImpl extends BackboneElementImpl implements ExplanationOfBenefitItem {
	...
	@XmlJavaTypeAdapter(PositiveIntImplAdapter.class)
	@XmlElement
	public List<PositiveInt> getCareTeamLinkId() {
	...
	@XmlJavaTypeAdapter(PositiveIntImplAdapter.class)
	@XmlElement
	public List<PositiveInt> getProcedureLinkId() {
	...
	@XmlJavaTypeAdapter(PositiveIntImplAdapter.class)
	@XmlElement
	public List<PositiveInt> getInformationLinkId() {
