 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.fhir.impl.SequenceQualityImpl#getType <em>Type</em>}</li>
...
@XmlRootElement(name = "fhir.SequenceQuality")
public class SequenceQualityImpl extends BackboneElementImpl implements SequenceQuality {
	...
	public NotificationChain basicSetType(QualityType newType, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.SEQUENCE_QUALITY__TYPE, oldType, newType);
	...
	public void setType(QualityType newType) {
		if (newType != type) {
			...
			if (type != null)
				msgs = ((InternalEObject)type).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.SEQUENCE_QUALITY__TYPE, null, msgs);
			if (newType != null)
				msgs = ((InternalEObject)newType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.SEQUENCE_QUALITY__TYPE, null, msgs);
			msgs = basicSetType(newType, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.SEQUENCE_QUALITY__TYPE, newType, newType));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FhirPackage.SEQUENCE_QUALITY__TYPE:
