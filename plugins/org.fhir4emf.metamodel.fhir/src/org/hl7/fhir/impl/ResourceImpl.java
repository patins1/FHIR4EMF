...
@XmlSeeAlso({ EncounterImpl.class, EnrollmentResponseImpl.class, MedicationImpl.class, AppointmentResponseImpl.class, StructureDefinitionImpl.class, RequestGroupImpl.class, ProvenanceImpl.class, PatientImpl.class, EligibilityResponseImpl.class, BinaryImpl.class, ScheduleImpl.class, DeviceMetricImpl.class,
		...
		DeviceUseStatementImpl.class, DeviceImpl.class, EligibilityRequestImpl.class, SearchParameterImpl.class, CapabilityStatementImpl.class, AppointmentImpl.class, OrganizationImpl.class, DocumentReferenceImpl.class, ContractImpl.class, SupplyRequestImpl.class, VisionPrescriptionImpl.class, DataElementImpl.class,
		ProcedureRequestImpl.class, SequenceImpl.class, OperationDefinitionImpl.class, ParametersImpl.class, GraphDefinitionImpl.class, PractitionerImpl.class, CarePlanImpl.class, AccountImpl.class, RelatedPersonImpl.class, RiskAssessmentImpl.class, AuditEventImpl.class, MeasureImpl.class, StructureMapImpl.class,
		...
		MedicationAdministrationImpl.class, BundleImpl.class, ListImpl.class, EnrollmentRequestImpl.class, GroupImpl.class, AllergyIntoleranceImpl.class, ImmunizationRecommendationImpl.class, PersonImpl.class, TaskImpl.class, SupplyDeliveryImpl.class, ExplanationOfBenefitImpl.class, BasicImpl.class, DocumentManifestImpl.class,
		...
		ConditionImpl.class, LibraryImpl.class, ServiceDefinitionImpl.class, FamilyMemberHistoryImpl.class, CareTeamImpl.class, DetectedIssueImpl.class, QuestionnaireResponseImpl.class, QuestionnaireImpl.class, CodeSystemImpl.class, ClaimImpl.class, ObservationImpl.class, ProcessResponseImpl.class, ImagingManifestImpl.class,
