...
@XmlSeeAlso({ EncounterImpl.class, EnrollmentResponseImpl.class, MedicationImpl.class, AppointmentResponseImpl.class, StructureDefinitionImpl.class, RequestGroupImpl.class, ProvenanceImpl.class, EligibilityResponseImpl.class, PatientImpl.class, BinaryImpl.class, ScheduleImpl.class, DeviceMetricImpl.class,
		CommunicationRequestImpl.class, MedicationStatementImpl.class, DeviceComponentImpl.class, EndpointImpl.class, CompartmentDefinitionImpl.class, AdverseEventImpl.class, ConsentImpl.class, ClaimResponseImpl.class, DiagnosticReportImpl.class, ConceptMapImpl.class, MedicationRequestImpl.class, DeviceImpl.class,
		GuidanceResponseImpl.class, DeviceUseStatementImpl.class, EligibilityRequestImpl.class, SearchParameterImpl.class, CapabilityStatementImpl.class, AppointmentImpl.class, OrganizationImpl.class, ContractImpl.class, DocumentReferenceImpl.class, SupplyRequestImpl.class, VisionPrescriptionImpl.class, ProcedureRequestImpl.class,
		DataElementImpl.class, SequenceImpl.class, OperationDefinitionImpl.class, ParametersImpl.class, PractitionerImpl.class, CarePlanImpl.class, AccountImpl.class, RelatedPersonImpl.class, AuditEventImpl.class, RiskAssessmentImpl.class, MeasureImpl.class, StructureMapImpl.class, DomainResourceImpl.class, SpecimenImpl.class,
		MeasureReportImpl.class, PaymentNoticeImpl.class, EpisodeOfCareImpl.class, MessageDefinitionImpl.class, ResearchStudyImpl.class, PaymentReconciliationImpl.class, CommunicationImpl.class, LinkageImpl.class, MediaImpl.class, ImagingStudyImpl.class, SlotImpl.class, MedicationAdministrationImpl.class, BundleImpl.class,
		ListImpl.class, EnrollmentRequestImpl.class, GroupImpl.class, AllergyIntoleranceImpl.class, ImmunizationRecommendationImpl.class, PersonImpl.class, SupplyDeliveryImpl.class, TaskImpl.class, ExplanationOfBenefitImpl.class, DocumentManifestImpl.class, BasicImpl.class, ClinicalImpressionImpl.class,
		MedicationDispenseImpl.class, OperationOutcomeImpl.class, NutritionOrderImpl.class, PlanDefinitionImpl.class, HealthcareServiceImpl.class, ProcessRequestImpl.class, ImmunizationImpl.class, TestScriptImpl.class, CompositionImpl.class, SubstanceImpl.class, ImplementationGuideImpl.class, ConditionImpl.class, LibraryImpl.class,
		ServiceDefinitionImpl.class, CareTeamImpl.class, FamilyMemberHistoryImpl.class, QuestionnaireResponseImpl.class, DetectedIssueImpl.class, CodeSystemImpl.class, QuestionnaireImpl.class, ClaimImpl.class, ObservationImpl.class, ProcessResponseImpl.class, ImagingManifestImpl.class, CoverageImpl.class, FlagImpl.class,
		ReferralRequestImpl.class, TestReportImpl.class, NamingSystemImpl.class, ActivityDefinitionImpl.class, ProcedureImpl.class, ValueSetImpl.class, ExpansionProfileImpl.class, BodySiteImpl.class, GoalImpl.class, CatalogImpl.class, ChargeItemImpl.class, PractitionerRoleImpl.class, SubscriptionImpl.class, MessageHeaderImpl.class,
		LocationImpl.class, ResearchSubjectImpl.class, DeviceRequestImpl.class })
...
public class ResourceImpl extends MinimalEObjectImpl.Container implements Resource {
	/**
	 * The cached value of the '{@link #getId() <em>Id</em>}' containment reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getId()
	 * @generated
	 * @ordered
	...
	/**
	 * The cached value of the '{@link #getMeta() <em>Meta</em>}' containment reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getMeta()
	 * @generated
	 * @ordered
	...
	/**
	 * The cached value of the '{@link #getImplicitRules() <em>Implicit Rules</em>}' containment reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * The cached value of the '{@link #getLanguage() <em>Language</em>}' containment reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getLanguage()
	 * @generated
	 * @ordered
